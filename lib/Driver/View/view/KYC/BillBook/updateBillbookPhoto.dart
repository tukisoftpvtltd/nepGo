...
class UpdateBillBookPhoto extends StatefulWidget {
   Function callback;
  String firstName;
  String phone;
  String email;
  ...
  @override
  State<UpdateBillBookPhoto> createState() => _UpdateBillBookPhotoState();
}

class _UpdateBillBookPhotoState extends State<UpdateBillBookPhoto> {
   String billBookImage = 'null';
  DriverDetailModel? model;
  getDriverDetail()async{
    print('Geting driver details');
  DriverRepository repo = DriverRepository();
   model= await repo.GetDriver();
   if(model!.driverDetails!.vechiclePhotos.toString() !="null"){
    setState(() {
     billBookImage = model!.driverDetails!.billbook.toString() ;
    });
   }
  ...
  if (image != null) {
    ...
    setState(() {
      billBookImage = '$randomString.jpg';
    });
          ...
          children: [
            Padding(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 15,),
                    Text('Upload your billbook photo',
                    ...
                    height: 250,
                                child:  FadeInImage.assetNetwork(
                                  ...
                                  image: '$baseUrl/driverimages/${billBookImage}',
                                  fit: BoxFit.cover,
                                ),
