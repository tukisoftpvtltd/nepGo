...
import 'package:food_app/Driver/View/view/signup.dart';
                        ...
                        onpressed: () async {
                          ...
                          if(emailValid == null || passwordValid == null){
                            ...
                            BlocProvider.of<SignInBloc>(context).add(
                                SignInSubmittedEvent(email.text,
                                 password.text,
                                 playerId));
                          } else
                            () {
