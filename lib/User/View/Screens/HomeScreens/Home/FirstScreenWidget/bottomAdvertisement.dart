...
class BottomAdvertisement extends StatefulWidget {
  var advertdata;
  int index;
   BottomAdvertisement({super.key,
  required this.advertdata,
  required this.index});

  @override
  State<BottomAdvertisement> createState() => _BottomAdvertisementState();
}

class _BottomAdvertisementState extends State<BottomAdvertisement> {
  var stateData;
        ...
        builder: (context, state) {
          ...
          GestureDetector(
            ...
            Image.network("https://meroato.tukisoft.com.np/advertisment/" +
                                    ...
                                    state.bottomAdvertisement.adSlider![0].adBanner
                                        .toString(),
                                        fit: BoxFit.cover,
                            )
