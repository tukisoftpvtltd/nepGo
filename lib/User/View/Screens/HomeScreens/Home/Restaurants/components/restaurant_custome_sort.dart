...
class RestaurantCustomSort extends StatefulWidget {
  ...
  final String Sales;
   RestaurantCustomSort({super.key,
  ...
  @override
  State<RestaurantCustomSort> createState() => _RestaurantCustomSortState();
}

class _RestaurantCustomSortState extends State<RestaurantCustomSort> {
