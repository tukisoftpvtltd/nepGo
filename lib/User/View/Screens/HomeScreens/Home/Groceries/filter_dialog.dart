...
class GroceriesFilterDialog extends StatefulWidget {
  final int index;
  ...
  final String Sales;
  GroceriesFilterDialog({super.key,
  required this.index,
  ...
  @override
  State<GroceriesFilterDialog> createState() => _GroceriesFilterDialogState();
}

class _GroceriesFilterDialogState extends State<GroceriesFilterDialog> {
