...
class GroceriesCustomSort extends StatefulWidget {
  ...
  @override
  State<GroceriesCustomSort> createState() => _GroceriesCustomSortState();
}

class _GroceriesCustomSortState extends State<GroceriesCustomSort> {
