...
class SearchMenuItems extends StatefulWidget {
  ...
  @override
  State<SearchMenuItems> createState() => _SearchMenuItemsState();
}

class _SearchMenuItemsState extends State<SearchMenuItems> {
  @override
              ...
              content: Container(
                ...
                child: Column(
                  ...
                  fit: BoxFit.cover,
                          ...
                          // Image.network(widget.itemImageUrl,
                          // fit: BoxFit.cover,)
                          )
                          ),
                    const SizedBox(
