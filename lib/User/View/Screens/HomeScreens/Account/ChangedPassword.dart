...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  changePassword()async{
    ...
    ChangePasswordRepository repo = new ChangePasswordRepository();
    bool response =await repo.changePassword(userId!, oldPasswordController.text, newPasswordController.text);
    setState(() {
      loading = false;
    });
  }
