...
class VerifyOTPPage extends StatefulWidget {
  ...
  final String userId;
  VerifyOTPPage(this.fromLogin,this.fromForgotPassword, this.email,this.password, this.OTPCode,this.phoneno,this.userId, {Key? key}) : super(key: key);
...
class _VerifyOTPPageState extends State<VerifyOTPPage> {
  ...
  OtpChecker() async{
    ...
    print(isVerified);
    print(widget.fromForgotPassword);
    if(isVerified ==true && widget.fromForgotPassword ==true){
      Get.to(ChangeForgotPassword(uid: widget.userId,));
    }
    else if(isVerified ==true && widget.fromLogin ==true){
